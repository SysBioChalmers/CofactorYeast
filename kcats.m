...
figure('Name','1');
box on;
scatter(kcatsc,kcat1);
xlim([-5 5]);
ylim([-5 5]);
set(gca,'FontSize',9,'FontName','Helvetica');
ylabel('log10 (median kcat)','FontSize',12,'FontName','Helvetica');
xlabel('log10 (kcat of matched organism and substrate)','FontSize',12,'FontName','Helvetica');
title('matched substrate with other organism','FontSize',14,'FontName','Helvetica');
str_rmse = ['RMSE = ',num2str(round(rmse1,2))];
str_r = ['R = ',num2str(round(R1(1,2),2))];
str_n = ['N = ',num2str(N_samples)];
text(-4.5,4.5,str_rmse,'FontSize',12,'FontName','Helvetica');
text(-4.5,3.5,str_r,'FontSize',12,'FontName','Helvetica');
text(-4.5,-4.5,str_n,'FontSize',12,'FontName','Helvetica');
...
figure('Name','2');
box on;
scatter(kcatsc,kcat2);
xlim([-5 5]);
ylim([-5 5]);
set(gca,'FontSize',9,'FontName','Helvetica');
ylabel('log10 (median kcat)','FontSize',12,'FontName','Helvetica');
xlabel('log10 (kcat of matched organism and substrate)','FontSize',12,'FontName','Helvetica');
title('matched organism with other substrate','FontSize',14,'FontName','Helvetica');
...
text(-4.5,3.5,str_r,'FontSize',12,'FontName','Helvetica');
text(-4.5,-4.5,str_n,'FontSize',12,'FontName','Helvetica');
set(gcf,'position',[300 0 280 280]);
set(gca,'position',[0.15 0.15 0.75 0.75]);

figure('Name','3');
box on;
scatter(kcatsc,kcat3);
xlim([-5 5]);
ylim([-5 5]);
set(gca,'FontSize',9,'FontName','Helvetica');
ylabel('log10 (median kcat of reported kcats)','FontSize',12,'FontName','Helvetica');
xlabel('log10 (kcat of matched organism and substrate)','FontSize',12,'FontName','Helvetica');
...
text(-4.5,3.5,str_r,'FontSize',12,'FontName','Helvetica');
text(-4.5,-4.5,str_n,'FontSize',12,'FontName','Helvetica');
set(gcf,'position',[600 0 280 280]);
set(gca,'position',[0.15 0.15 0.75 0.75]);
...
figure('Name','4');
box on;
scatter(kcatsc,kcata);
xlim([-6 6]);
ylim([-6 6]);
set(gca,'FontSize',9,'FontName','Helvetica');
ylabel('log10 (kcat collected by the method)','FontSize',12,'FontName','Helvetica');
xlabel('log10 (kcat of matched organism and substrate)','FontSize',12,'FontName','Helvetica');
title('Method A','FontSize',14,'FontName','Helvetica');
str_rmse = ['RMSE = ',num2str(round(rmsea,2))];
str_r = ['R = ',num2str(round(Ra(1,2),2))];
str_n = ['N = ',num2str(N_samples)];
text(-5.5,5.5,str_rmse,'FontSize',12,'FontName','Helvetica');
text(-5.5,4.5,str_r,'FontSize',12,'FontName','Helvetica');
text(-5.5,-5.5,str_n,'FontSize',12,'FontName','Helvetica');
set(gcf,'position',[900 0 280 280]);
set(gca,'position',[0.15 0.15 0.75 0.75]);

figure('Name','5');
box on;
scatter(kcatsc,kcatb);
xlim([-6 6]);
ylim([-6 6]);
set(gca,'FontSize',9,'FontName','Helvetica');
ylabel('log10 (kcat collected by the method)','FontSize',12,'FontName','Helvetica');
...
text(-5.5,4.5,str_r,'FontSize',12,'FontName','Helvetica');
text(-5.5,-5.5,str_n,'FontSize',12,'FontName','Helvetica');
set(gcf,'position',[1200 0 280 280]);
set(gca,'position',[0.15 0.15 0.75 0.75]);

figure('Name','6');
box on;
scatter(kcatsc,kcatc);
xlim([-6 6]);
ylim([-6 6]);
set(gca,'FontSize',9,'FontName','Helvetica');
ylabel('log10 (kcat collected by the method)','FontSize',12,'FontName','Helvetica');
...
text(-5.5,4.5,str_r,'FontSize',12,'FontName','Helvetica');
text(-5.5,-5.5,str_n,'FontSize',12,'FontName','Helvetica');
set(gcf,'position',[1500 0 280 280]);
set(gca,'position',[0.15 0.15 0.75 0.75]);
