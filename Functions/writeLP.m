%% writeLP 
function fileName = writeLP(model,mu,f,f_mito,osenseStr,rxnID,enzymedata,factor_k_withoutcofator,factor_k)
...
%     if ismember(enzyme,ole1)
%         kcat = enzymedata.kcat(ismember(enzymedata.enzyme,enzyme))*0.1;
%     end
