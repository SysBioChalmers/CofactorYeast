...
function simulationLowerUptakeOCNPS(mw)
...
%% Solve LPs
ion_mw_list = [16 12 14 31 32];
ion_list = {'O' 'C' 'N' 'P' 'S'};
rxnName_list = {'oxygen exchange'; ...
                'D-glucose exchange'; ...
                'ammonium exchange'; ...
                'phosphate exchange'; ...
                'sulphate exchange'};
...
filename_1 = strcat('sLUOCNPS_fluxes_',ion,'.mat');
filename_2 = strcat('sLUOCNPS_labels_',ion,'.mat');
cd tmp_results/;
