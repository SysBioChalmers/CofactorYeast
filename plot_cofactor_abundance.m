...
for i = 1:length(exp_cofactor)
    ...
    scatter(x_tmp,log10(y_tmp),50,'o','LineWidth',1,'MarkerEdgeColor',clr_tmp);
end
scatter(1:1:length(cftrlist),log10(atomlist),70,'kx','LineWidth',1);
ylim([4 11]);
xlim([0.1 8.9]);
set(gca,'XTickLabel',cftrlist);
set(gca,'FontSize',8,'FontName','Helvetica');
ylabel('log10(Atoms/cell)','FontSize',8,'FontName','Helvetica');

set(gcf,'position',[200 0 240 180]);
