...
################################################################################
# createECfiles
# Reads all data and creates all EC files.
#
# Yu Chen. Last edited: 2019-11-28
################################################################################

#INPUTS:
#1) Path in which all BRENDA queries are (from script retrieveBRENDAcofactors.py):
input_path = '/Users/.../brenda_parser_cofactors/raw_data'
#2) Path in which you wish to store all EC files:
output_path = '/Users/.../brenda_parser_cofactors/EC_files'
...
for i in dir_files:
    ...
    if var_name == 'METALSIONS':
        variable  = '#metalsIons*'

    elif var_name == 'COFACTOR':
        variable  = '#cofactor*'
