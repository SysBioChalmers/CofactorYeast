...
% PCA for using theta of 0.5
load('sLU_res.mat');
load('sLUT050_res.mat');
load('CofactorYeast.mat');

fluxes = [sLUT050_res.fluxes sLU_res.fluxes(:,length(sLUT050_res.labels)+1:length(sLU_res.labels))];
labels = sLU_res.labels;
% fluxes = [sLUT050_res.fluxes sLU_res.fluxes];
% labels = [sLUT050_res.labels sLU_res.labels];
rxns = model.rxns;
clear sLU_res;
