...
pHCA = flux(strcmp(model.rxns,'new_r_HCAex'),:);
fe = -1*flux(strcmp(model.rxns,'r_1861'),:);
...
hold on;
box on;
plot(mu,pHCA./glc,'-o','MarkerSize',2,'LineWidth',0.75,'Color',[55,126,184]/255);
xlim([0 0.4]);
set(gca,'FontSize',6,'FontName','Helvetica');
...
hold on;
box on;
plot(mu,pHCA,'-o','MarkerSize',2,'LineWidth',0.75,'Color',[55,126,184]/255);
xlim([0 0.4]);
set(gca,'FontSize',6,'FontName','Helvetica');
xlabel('Growth rate (/h)','FontSize',7,'FontName','Helvetica');
ylabel(['pHCA production flux',char(13,10)','(mmol/gCDW/h)'],'FontSize',7,'FontName','Helvetica');
